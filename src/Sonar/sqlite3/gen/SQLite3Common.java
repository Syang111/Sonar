...
public final class SQLite3Common {
    ...
    public static String getFreeColumnName(SQLite3Table t,SQLite3GlobalState globalState) {
        List<SQLite3Column> indexNames = t.getColumns();
        final String[] candidateName = new String[1];
        do {
            candidateName[0] = DBMSCommon.createColumnName(globalState.getColumns());

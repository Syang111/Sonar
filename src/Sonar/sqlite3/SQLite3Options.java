...
import Sonar.sqlite3.oracle.SQLite3Fuzzer;
import Sonar.sqlite3.oracle.SQLite3SonarOracle;
import Sonar.sqlite3.oracle.SQLite3NoRECOracle;
import Sonar.sqlite3.oracle.SQLite3PivotedQuerySynthesisOracle;
import Sonar.sqlite3.oracle.tlp.SQLite3TLPAggregateOracle;
import Sonar.sqlite3.oracle.tlp.SQLite3TLPDistinctOracle;
import Sonar.sqlite3.oracle.tlp.SQLite3TLPGroupByOracle;
import Sonar.sqlite3.oracle.tlp.SQLite3TLPHavingOracle;
import Sonar.sqlite3.oracle.tlp.SQLite3TLPWhereOracle;
...
public class SQLite3Options implements DBMSSpecificOptions<SQLite3OracleFactory> {
    ...
    public SQLite3OracleFactory oracles = SQLite3OracleFactory.Sonar;
    ...
    public enum SQLite3OracleFactory implements OracleFactory<SQLite3GlobalState> {
        ...
        Sonar {
            @Override
            public TestOracle<SQLite3GlobalState> create(SQLite3GlobalState globalState) throws SQLException {
                return new SQLite3SonarOracle(globalState);
            }
        };
    }

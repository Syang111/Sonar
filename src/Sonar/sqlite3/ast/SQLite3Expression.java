...
public abstract class SQLite3Expression {
    ...
    public static class SQLite3ManuelPredicate extends SQLite3Expression {

        private final String predicate;

        public SQLite3ManuelPredicate(String predicate) {

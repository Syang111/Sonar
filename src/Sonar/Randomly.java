...
public final class Randomly {
    ...
    public static String getRandomDate() {
        ...
        int year = random.nextInt(9999 - 1900 + 1) + 1900;
    ...
    public static String getRandomDateTime() {
        Random random = new Random();
        int year = random.nextInt(9999 - 1000 + 1) + 1000;
        int month = random.nextInt(12) + 1;
        int day = random.nextInt(28) + 1;
        int hour = random.nextInt(24);
        int minute = random.nextInt(60);
        int second = random.nextInt(60);
        int nanos = random.nextInt(999999);
        return String.format("%d-%02d-%02d %02d:%02d:%02d.%06d", year, month, day, hour, minute, second, nanos);
    }
    ...
    public static String getRandomDAY_MICROSECOND() {
        Random random = new Random();
        ...
        int second = random.nextInt(60);
        int nanos = random.nextInt(999999);
        return String.format("%d %02d:%02d:%02d.%06d", day, hour, minute, second, nanos);
    }


    public static String getRandomYearMonth() {
        Random random = new Random();
        int randomYear = random.nextInt(200) + 1920;


        int randomMonth = random.nextInt(12) + 1;


        return String.format("%04d%02d", randomYear, randomMonth);
    }
}

...
import Sonar.Randomly.StringGenerationStrategy;
...
public class MainOptions {
    ...
    private boolean loggerPrintFailed = false;
    ...
    @Parameter(names = "--print-progress-summary", description = "Whether to print an execution summary when exiting Sonar", arity = 1)

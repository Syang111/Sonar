...
public class StatementExecutor<G extends GlobalState<?, ?, ?>, A extends AbstractAction<G>> {
    ...
    public void addPostgresErrors(ExpectedErrors errors){
    }
        ...
        while (total != 0) {
            ...
            try {
                ...
                do {
                    ...
                    if (globalState.getOptions().getUserName().contains("postgres")){
                        addPostgresErrors(((SQLQueryAdapter) query).getErrors());
                    }

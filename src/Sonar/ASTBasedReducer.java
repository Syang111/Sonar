...
import Sonar.transformations.RemoveClausesOfSelect;
import Sonar.transformations.RemoveColumnsOfSelect;
import Sonar.transformations.RemoveElementsOfExpressionList;
import Sonar.transformations.RemoveRowsOfInsert;
import Sonar.transformations.RemoveUnions;
import Sonar.transformations.RoundDoubleConstant;
import Sonar.transformations.SimplifyConstant;
import Sonar.transformations.SimplifyExpressions;
import Sonar.transformations.Transformation;

public class ASTBasedReducer<G extends GlobalState<O, ?, C>, O extends DBMSSpecificOptions<?>, C extends SonarDBConnection>

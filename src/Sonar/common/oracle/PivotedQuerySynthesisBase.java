...
public abstract class PivotedQuerySynthesisBase<S extends GlobalState<?, ?, C>, R extends AbstractRowValue<?, ?, ?>, E, C extends SonarDBConnection>
    ...
    private boolean containsRows(Query<C> query) throws Exception {
        try (SonarResultSet result = query.executeAndGet(globalState)) {
            if (result == null) {

package Sonar.mysql.gen.datadef;
...
public class MySQLIndexGenerator {
    ...
    public SQLQueryAdapter create() {
        ...
        errors.add("Compression failed with the following error : Punch hole not supported by the filesystem or the tablespace page size is not large enough.");

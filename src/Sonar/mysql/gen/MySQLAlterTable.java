...
public class MySQLAlterTable {
    ...
    private enum Action {
        ALGORITHM("Compression failed with the following error : Punch hole not supported by the filesystem or the tablespace page size is not large enough."),
        CHECKSUM("Compression failed with the following error : Punch hole not supported by the filesystem or the tablespace page size is not large enough."),
        COMPRESSION("Compression failed with the following error : Punch hole not supported by the filesystem or the tablespace page size is not large enough."),
        ...
        ROW_FORMAT,
        STATS_AUTO_RECALC,
        STATS_PERSISTENT("Compression failed with the following error : Punch hole not supported by the filesystem or the tablespace page size is not large enough."),
        PACK_KEYS, RENAME("doesn't exist", "already exists","Compression failed with the following error : Punch hole not supported by the filesystem or the tablespace page size is not large enough."), 
        DROP_PRIMARY_KEY(

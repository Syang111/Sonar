...
public class MySQLNoRECOracle extends NoRECBase<MySQLGlobalState> implements TestOracle<MySQLGlobalState> {
    ...
    public MySQLNoRECOracle(MySQLGlobalState globalState) {
        super(globalState);
    ...
    public void check() throws SQLException {
        ...
        if (optimizedResultSet.size()!= unoptimizedResultSet.size()) {
            String queryFormatString = "-- %s;" + System.lineSeparator() + "-- cardinality: %d"
                    + System.lineSeparator();
            String firstQueryString = String.format(queryFormatString, optimizedQueryString, optimizedResultSet.size());
            String secondQueryString = String.format(queryFormatString, unoptimizedQueryString, unoptimizedResultSet.size());
            ...
            String assertionMessage = String.format(
                    ...
                    optimizedResultSet.size(), unoptimizedResultSet.size(), optimizedQueryString, optimizedResultSet.size(),
                    unoptimizedQueryString, unoptimizedResultSet.size());
    ...
    private String getOptimizedQuery(MySQLSelect select) throws SQLException {
        ...
        if (Randomly.getBoolean()) {
            select.setFromOptions(MySQLSelect.SelectType.DISTINCT);
        }

...
public class MariaDBSchema extends AbstractSchema<MariaDBGlobalState, MariaDBTable> {
    ...
    public MariaDBSchema.MariaDBTables getRandomTableNonEmptyTables() {
        return new MariaDBSchema.MariaDBTables(Randomly.nonEmptySubset(getDatabaseTables()));
    }
}
